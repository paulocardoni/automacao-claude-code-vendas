...
export default function Hero() {
  return (
    <section className="relative pt-8 pb-8 sm:pt-12 sm:pb-12 md:pt-16 md:pb-16 px-4 sm:px-6 md:px-8 overflow-hidden" role="region" aria-label="Secao principal da formacao agentica">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-center">
          <div className="animate-slide-in-up order-2 md:order-1 min-h-auto flex flex-col justify-center">
            ...
            <h1 className="text-xl sm:text-3xl md:text-5xl lg:text-6xl font-bold mb-2 sm:mb-3 leading-tight" style={{ fontFamily: "'Poppins', sans-serif" }}>
              Como gestores de trafego estao eliminando <span className="text-orange-400">12h de trabalho manual</span> por semana sem saber programar
            </h1>

            <p className="text-xs sm:text-base md:text-lg text-gray-300 mb-3 sm:mb-4 leading-relaxed">
              Relatorios automaticos, analises de campanhas, otimizacoes em lote. Tudo que voce faz no braco hoje, o Claude Code faz por voce em minutos.
            </p>
